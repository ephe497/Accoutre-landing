      ...
      <div className="py-[26px] lg:px-[75px] md:px-[45px] px-[20px] ">
        <div className="hidden md:flex justify-between items-center">
          <div className="flex justify-between">
            <p className="text-[#0D1417] text-[11px] font-[500] font-PlusJakataSan ">About us</p>
            <p className="lg:pl-[80px] pl-[30px] text-[11px] text-[#0D1417] font-semibold  font-PlusJakataSan">
              Contact
            </p>
          </div>

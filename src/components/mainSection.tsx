      ...
      <div className="backImg pb-o md:pb-[50px]">
        ...
        <ContentWrapper>
          <div className=" block md:grid grid-cols-2 text-center">
            <div className="bg-[#EDF8EC] font-Josefin md:font-PlusJakataSan text-[#4CBE42] font-[700] text-[16px] md:text-[30px] py-6 ">
              Are you a skilled professional?
            </div>
            <div className="w-100">
              <div className="bg-[#ECEEF0] font-Josefin md:font-PlusJakataSan font-[700]  text-[#42536A] text-[16px] md:text-[30px] py-6 ">
